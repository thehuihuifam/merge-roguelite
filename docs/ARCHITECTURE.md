...
| ----------------------- | ------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------- | ----------------------------------------------------------------- | ------------------------------- |
| 머지 카드 / 리스크 카드 | `src/core/interfaces/IMergeCard.ts` (`MergeCard`, `RiskCard`, `IMergeCardProvider`, `MergeCardContext`) | 없음 (타입만)                                                        | `ISlowMotionSelector` 구현체가 사용                               | Task 1.2                        |
...
| 근접 실패 연출          | `src/core/interfaces/INearMissEffect.ts`                                                                | `src/systems/NoopNearMissEffect.ts`                                  | `new Game({ nearMissEffect })`                                    | Task 1.1, 2.1                   |
